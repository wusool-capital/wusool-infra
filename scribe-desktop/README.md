<div align="center" style="border-bottom: none">
    <h1>
        <img src="docs/WusoolScribe-6.png" style="border-radius: 10px;" />
        <br>
...
<p align="center">
    <img src="docs/wusoolscribe_demo.gif" width="650" alt="WusoolScribe Demo" />
    <br>
...
- [Why WusoolScribe?](#why-wusoolscribe)
- [Features](#features)
- [Installation](#installation)
- [Key Features in Action](#key-features-in-action)
- [System Architecture](#system-architecture)
- [For Developers](#for-developers)
- [WusoolScribe PRO](#wusoolscribe-pro)
...
**WusoolScribe solves this:** Complete data sovereignty on your infrastructure, zero vendor lock-in, and full control over your sensitive conversations.
...
- **Open Source:** WusoolScribe is open source and free to use.
...
3. Drag **WusoolScribe** to your Applications folder
4. Open **WusoolScribe** from Applications folder
...
<p align="center">
    <img src="docs/home.png" width="650" style="border-radius: 10px;" alt="WusoolScribe Demo" />
</p>
...
<p align="center">
    <img src="docs/wusoolscribe-export.gif" width="650" style="border-radius: 10px;" alt="Import and Enhance" />
</p>
...
WusoolScribe is a single, self-contained application built with [Tauri](https://tauri.app/). It uses a Rust-based backend to handle all the core logic, and a Next.js frontend for the user interface.

For more details, see the [Architecture documentation](docs/architecture.md).

## For Developers

If you want to contribute to WusoolScribe or build it from source, you'll need to have Rust and Node.js installed. For detailed build instructions, please see the [Building from Source guide](docs/BUILDING.md).
...
**WusoolScribe PRO** is a professional-grade solution with enhanced accuracy and advanced features for serious users and teams. Built on a different codebase with superior transcription models and enterprise-ready capabilities.

### Community Thank-You Offer

WusoolScribe Community Edition will remain free and open source. PRO exists for users and teams who want a more advanced meeting workflow, including higher transcription accuracy, custom summary templates, advanced exports, auto-meeting detection, and self-hosted deployment options.

For the community that helped WusoolScribe grow, we are making the upgrade easier: use coupon code **LAUNCH20** for **20% off WusoolScribe PRO** until the next WusoolScribe Community Edition release.
...
> **Note:** WusoolScribe Community Edition remains **free & open source forever** with local transcription, AI summaries, and core features. PRO is a separate professional solution for users who need enhanced accuracy and advanced capabilities.
