...
// Module-level component so the sonner Toaster follows the active theme
// without forcing RootLayout itself to re-render on every theme change.
    ...
    <Toaster
      ...
      toastOptions={{
        classNames: {
          ...
          error: '!border-l-2 !border-l-destructive [&_[data-icon]]:!text-destructive',
          warning: '!border-l-2 !border-l-warning [&_[data-icon]]:!text-warning',
          info: '!border-l-2 !border-l-info [&_[data-icon]]:!text-info',
        },
      }}
    />
  );
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Applied before paint to avoid a dark-mode flash -- light is the default. */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('wusoolscribe-theme');document.documentElement.classList.toggle('dark', t === 'dark');}catch(e){}})();`,
          }}
        />
      </head>
      <body
