    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm bg-card border border-border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring disabled:bg-muted disabled:text-muted-foreground"
        >
