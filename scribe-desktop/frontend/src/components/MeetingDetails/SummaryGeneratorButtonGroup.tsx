    ...
    <ButtonGroup>
      ...
      {isGenerating ? (
        <Button
          variant="outline"
          size="sm"
          className="bg-gradient-to-r from-destructive/10 to-warning/10 hover:from-destructive/15 hover:to-warning/15 border-destructive/30 xl:px-4"
          onClick={() => {
        ...
        <Button
          variant="outline"
          size="sm"
          className="bg-gradient-to-r from-primary/10 to-purple-50 hover:from-primary/15 hover:to-purple-100 border-primary/30 xl:px-4"
          onClick={() => {
