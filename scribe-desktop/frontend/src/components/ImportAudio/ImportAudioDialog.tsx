              ...
              {fileInfo ? (
                <div className="bg-muted rounded-lg p-4 space-y-3">
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-foreground/90">Meeting Title</label>
                    <Input
                      value={title}
                      onChange={(e) => {
              ...
              {fileInfo && (
                <div className="border rounded-lg">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 text-sm font-medium text-foreground/90 hover:bg-accent/60"
                  >
          ...
          {isProcessing && progress && (
            <div className="space-y-2">
              <div className="relative">
                <Progress value={Math.min(progress.progress_percentage, 100)} className="h-3" />
