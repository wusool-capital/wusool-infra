        ...
        {modelConfig.provider === 'ollama' && (
          <div>
            ...
            {isLoadingOllama ? (
                      ...
                      <div className="space-y-3">
                        ...
                        {isDownloading('gemma3:1b') && getProgress('gemma3:1b') !== undefined && (
                          <div className="bg-card rounded-md border p-3">
                            ...
                            <Progress value={getProgress('gemma3:1b')} />
                          </div>
                        )}
                      </div>
                    )}
              ...
              <ScrollArea className="max-h-[calc(100vh-450px)] pr-4">
      ...
      <div className="mt-6 flex justify-end">
        <Button
          className={cn(
            ...
            isDoneDisabled ? 'bg-muted-foreground/40 cursor-not-allowed' : 'bg-primary hover:bg-primary/90'
          )}
          onClick={handleSave}
