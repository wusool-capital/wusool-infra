        ...
        match Command::new("osascript")
            ...
            .arg(r#"
                tell application "Terminal"
                    activate
                    do script "log stream --process wusoolscribe --level info --style compact"
                end tell
            "#)
            .spawn()
        {
            ...
            .arg(r#"
                tell application "Terminal"
                    ...
                    repeat with aWindow in windowList
                        if contents of selected tab of aWindow contains "log stream --process wusoolscribe" then
                            close aWindow
                        end if
                    end repeat
                end tell
