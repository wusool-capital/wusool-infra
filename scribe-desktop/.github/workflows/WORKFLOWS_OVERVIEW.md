...
- Artifacts prefixed with `wusoolscribe-test-`
...
```
wusoolscribe-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `wusoolscribe-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `wusoolscribe-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `wusoolscribe-macos-aarch64-release-0.1.3`
