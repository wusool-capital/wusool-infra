...
When **reviewing recordings** in WusoolScribe, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **WusoolScribe records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing WusoolScribe recordings** - Use wired/speakers instead
...
### This is Not a WusoolScribe Bug

The issue is in **macOS's Bluetooth audio stack**, not in WusoolScribe's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a WusoolScribe bug. We've correctly recorded at 48kHz.
...
**A**: Yes! WusoolScribe now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: WusoolScribe v0.0.5+ on macOS
