...
-- recently created/updated/removed/restored this row) — a "who do I ask
...
ALTER TABLE seller_roles ADD COLUMN IF NOT EXISTS removed_at timestamptz;
...
ALTER TABLE buyer_roles ADD COLUMN IF NOT EXISTS removed_at timestamptz;
