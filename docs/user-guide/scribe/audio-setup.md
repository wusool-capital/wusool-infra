...
WusoolScribe records your microphone and your computer's system audio (for
...
- **macOS** — requires a virtual audio device (such as BlackHole) to be
  installed, plus microphone and screen-recording permissions.
- **Windows** — uses the system's built-in audio loopback; no extra software
  required.
