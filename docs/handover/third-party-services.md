...
| Firecrawl | Web-lead fallback in matching, and the free-text research tier for `/enrich-seller`/`/enrich-buyer` | API key optional; the feature disables cleanly without it |
