...
import app.modules.web_search.infrastructure.firecrawl_maps_client as maps_module
from app.modules.web_search.infrastructure.firecrawl_maps_client import (
    FirecrawlMapsClient,
    _match_place_link,
)
