...
module calls `app.modules.ddl_commands.bootstrap.create_app()`, which reads settings) so
...
from app.modules.ddl_commands.persistence.database import get_engine, import_all_models
