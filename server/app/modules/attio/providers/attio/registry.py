...
async def _load_objects(client: AttioClientProtocol) -> dict[str, str]:
...
async def _load_lists(client: AttioClientProtocol) -> dict[str, str]:
...
async def object_slug(client: AttioClientProtocol, object_id: str) -> str | None:
...
async def list_slug(client: AttioClientProtocol, list_id: str) -> str | None:
