...
from app.modules.lead_magnets.domain.benchmark.benchmark import MetricKey
from app.modules.lead_magnets.domain.shared.schemas import FlagCopy

SME_FLAG_COPY: dict[str, FlagCopy] = {
    MetricKey.EBITDA: FlagCopy(
