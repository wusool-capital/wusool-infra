...
# Prod's equivalent of ../dev/backfill-activities.ps1. One-time
...
#
# Crosswalk is one hop here, not two: the dev version bridges
...
#
# The old dev script also backfills a "Mandate" subject_type
